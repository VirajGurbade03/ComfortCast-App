...
//   String humidity = 'Load.';
//   String co2Level = 'Load.';
//   String bodytemp = 'Load.';
//   String coretemp = 'Load.';
//   String activitylevel = 'Load.';
//   String stepscont = '0';
//   String heartrate = '0';
//   String oxygen = '0';
...
//   void _fetchData() {
//     _databaseReference
//         .child('/D1/Wearable/Room Temperature')
//         .onValue
//         .listen((event) {
...
//     _databaseReference.child('/D1/Wearable/Humidity').onValue.listen((event) {
...
//     //Today Activity
//     _databaseReference
//         .child('/D1/Wearable/Body Temperature')
//         .onValue
//         .listen((event) {
...
//     _databaseReference
//         .child('/D1/Wearable/Core temperature')
//         .onValue
//         .listen((event) {
//       final String bote = event.snapshot.value.toString();
//       setState(() {
...
//       setState(() {
//         activitylevel = actlev;
//       });
//     });

//     _databaseReference.child('/D1/Wearable/Steps').onValue.listen((event) {
...
//     _databaseReference.child('/D1/Wearable/Heart Rate').onValue.listen((event) {
...
//                                         color:
//                                             const Color.fromARGB(30, 0, 255, 30)
//                                                 .withOpacity(0.3),
//                                         thicknessUnit: GaugeSizeUnit.factor,
//                                       ),
//                                       pointers: <GaugePointer>[
//                                         RangePointer(
//                                           value: double.tryParse(stepscont) ??
...
//                                       Text(
//                                         stepscont.split('.')[
//                                             0], // Split the string at the decimal point and take the first part
...
//                                 value: heartrate,
//                                 unit: 'bpm',
//                                 imagePath: 'lib/assets/images/heart_rate.png',
//                               ),
...
//                                 value: bodytemp,
//                                 unit: '°C',
//                                 imagePath: 'lib/assets/images/body_tempe.png',
//                               ),
//                               const SizedBox(width: 12),
//                               TodayActivityWidget(
//                                 title: 'Core Tempe',
//                                 value: coretemp,
//                                 unit: '°C',
//                                 imagePath: 'lib/assets/images/coretempe.png',
//                               ),
//                               const SizedBox(width: 12),
//                               TodayActivityWidget(
//                                 title: 'Oxygen Level',
...
//                                 value: totalValue,
//                                 unit: 'clo',
//                                 imagePath: 'lib/assets/images/clothing.png',
//                               ),
//                               const SizedBox(width: 12),
//                               TodayActivityWidget(
...
//                                 value: activitylevel,
//                                 unit: 'met',
//                                 imagePath: 'lib/assets/images/Activity.png',
//                               ),
//                             ],
//                           ),
//                         ),
...
//                                   value: temperature,
//                                   unit: '°C',
//                                   imagePath: 'lib/assets/images/room_tempe.png',
//                                 ),
...
//                                 DataWidget(
//                                   title: 'CO2 Level',
//                                   value: co2Level.split('.')[0],
//                                   unit: 'ppm',
//                                   imagePath: 'lib/assets/images/Co2_level.png',
//                                 ),
//                               ],
//                             )),
//                       ),
